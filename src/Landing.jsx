...
const REAL_REFUNDS = [
  {
    ...
    quote: 'I forgot a free trial and got charged $119.88 overnight. Copied the custom evidence file generated by Bill Vampire, cited state auto-renewal law, and support reversed the charge in 2 hours!',
    author: 'Jessica T.',
    platform: 'r/Frugal user',
    caseUrl: '/cases/how-i-got-119-back-from-forgotten-canva-pro-trial.html'
  },
  {
    service: 'Adobe Creative Cloud',
    saved: '$113.90',
    outcome: 'Early Termination Waived',
    badgeColor: 'bg-violet-500/10 text-violet-400 border-violet-500/20',
    quote: 'Adobe tried to hit me with a $113.90 early termination fee to cancel. Used the legal precedent script from Bill Vampire. The chat agent waived the entire fee and canceled my account immediately.',
    author: 'Marcus K.',
    platform: 'Indie Hackers',
    caseUrl: '/cases/how-to-negotiate-adobe-early-termination-fee-refund.html'
  },
  {
    service: 'Microsoft 365',
    saved: '$99.99',
    outcome: 'Renewal Refunded',
    badgeColor: 'bg-amber-500/10 text-amber-400 border-amber-500/20',
    quote: 'Accidental Office annual renewal hit my card. I had no idea where the refund button was hidden. Followed Bill Vampire\'s cancel path and support script to trigger automatic refund eligibility.',
    author: 'David R.',
    platform: 'Twitter/X user',
    caseUrl: '/cases/getting-refunded-for-99-dollar-microsoft-365-accidental-renewal.html'
  }
];
...
export default function Landing({ onEnterApp, onLegal, onAuthRequest }) {
  ...
  return (
    <div className="bv-brutal min-h-screen bg-[#0B0B11] text-slate-100 overflow-x-hidden">
      ...
      {/* ===== REAL REFUNDS PROOF & SUCCESS STORIES ===== */}
      <section className="py-20 lg:py-28 bg-[#0B0B11]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-xs font-medium text-emerald-400 uppercase tracking-widest mb-3">Success Records — Real Refund Proofs</p>
            <h2 className="tracking-heading text-3xl lg:text-4xl font-bold text-slate-100 mb-4">
              Proven rescue records. <span className="text-emerald-400">Real money returned.</span>
            </h2>
            <p className="text-sm text-slate-500 max-w-lg mx-auto">
              Read step-by-step case studies and exact evidence files of consumers successfully reversing trial charges and waiving termination fees.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {REAL_REFUNDS.map((r, i) => (
              <a
                key={i}
                href={r.caseUrl}
                onClick={() => track('proof_card_clicked', { service: r.service, saved: r.saved })}
              ...
              >
                ...
                <div className="flex items-center gap-2 pt-4 border-t border-slate-800/40">
                  <div className="w-6 h-6 rounded-full bg-emerald-950/40 border border-emerald-900/30 flex items-center justify-center shrink-0">
                    <span className="text-[10px] font-bold text-emerald-400">{r.author[0]}</span>
                  </div>
                  <div className="text-[10px]">
                    <span className="text-slate-300 font-bold block">{r.author}</span>
