...
const EXAMPLE_CASES = [
  {
    service: 'Canva Pro',
    amount: '$119.88',
    outcome: 'Trial-renewal example',
    badgeColor: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
    summary: 'A worked example showing the cancellation proof, receipt details, and concise refund request someone could prepare after a Canva Pro trial renewal.',
    caseUrl: '/cases/how-i-got-119-back-from-forgotten-canva-pro-trial'
  },
  {
    service: 'Adobe Creative Cloud',
    amount: '$113.90',
    outcome: 'Fee-review example',
    badgeColor: 'bg-violet-500/10 text-violet-400 border-violet-500/20',
    summary: 'A worked example for documenting an Adobe annual-plan fee and asking support to explain or review the charge without promising a waiver.',
    caseUrl: '/cases/how-to-negotiate-adobe-early-termination-fee-refund'
  },
  {
    service: 'Microsoft 365',
    amount: '$99.99',
    outcome: 'Renewal-review example',
    badgeColor: 'bg-amber-500/10 text-amber-400 border-amber-500/20',
    summary: 'A worked example showing the Microsoft cancellation flow, order evidence, and support request for an unintended annual renewal.',
    caseUrl: '/cases/getting-refunded-for-99-dollar-microsoft-365-accidental-renewal'
  }
];
...
const REFUND_GUIDE_LINKS = [
  {
    ...
    href: '/refund/adobe-cancellation-fee-refund-email-template',
    amount: '$54.99+',
    issue: 'Hard cancel',
  },
  {
    title: 'Microsoft 365 annual renewal',
    href: '/refund/microsoft-365-refund-after-annual-renewal',
    amount: '$99.99',
    issue: 'Annual renewal',
  },
  {
    title: 'Canva Pro trial charge',
    href: '/refund/canva-pro-trial-refund-after-119-charge',
    amount: '$119',
    issue: 'Trial refund',
  },
  {
    title: 'Tinder Gold accidental purchase',
    href: '/refund/tinder-gold-refund-after-accidental-purchase',
    amount: '$149.99',
    issue: 'App purchase',
  },
];
...
export default function Landing({ onEnterApp, onOpenApp, onLegal, onAuthRequest, auth }) {
  ...
  return (
    <div className="bv-brutal min-h-screen bg-[#0B0B11] text-slate-100 overflow-x-hidden">
      ...
      {/* ===== ILLUSTRATIVE CASE WORKFLOWS ===== */}
      <section className="py-20 lg:py-28 bg-[#0B0B11]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-xs font-medium text-emerald-400 uppercase tracking-widest mb-3">Illustrative case workflows</p>
            <h2 className="tracking-heading text-3xl lg:text-4xl font-bold text-slate-100 mb-4">
              See the evidence and message <span className="text-emerald-400">before contacting support.</span>
            </h2>
            <p className="text-sm text-slate-500 max-w-lg mx-auto">
              These are worked examples—not verified customer outcomes. Refunds and fee waivers depend on the provider, billing channel, region, timing, and account use.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {EXAMPLE_CASES.map((r) => (
              <a
                key={r.service}
                href={r.caseUrl}
                onClick={() => track('example_case_clicked', { service: r.service, amount: r.amount })}
                className="block glass-card glass-card-hover rounded-2xl p-6 transition-all hover:scale-[1.02] border-slate-800/40 hover:border-emerald-500/30 no-underline"
              >
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-bold text-slate-400">{r.service}</span>
                  <span className={`text-[10px] font-bold px-2 py-1 rounded border ${r.badgeColor}`}>
                    Example {r.amount}
                  </span>
                </div>
                <div className="mb-4 text-[11px] font-bold text-emerald-400 tracking-wider uppercase">
                  ✓ {r.outcome}
                </div>
                ...
                <div className="flex items-center gap-2 pt-4 border-t border-slate-800/40">
                  <span className="text-[10px] text-slate-500">Educational scenario · Outcome not guaranteed</span>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 items-start">
            ...
            <div className="glass-card rounded-2xl p-6 border-slate-800/40">
              ...
              <ul className="space-y-3 text-xs text-slate-400">
                <li><a href="/refund/adobe-cancellation-fee-refund-email-template" className="hover:text-amber-400 transition-colors">Adobe Cancellation Fee</a></li>
                <li><a href="/refund/canva-pro-trial-refund-after-119-charge" className="hover:text-amber-400 transition-colors">Canva Pro Trial Refund</a></li>
                <li><a href="/refund/microsoft-365-refund-after-annual-renewal" className="hover:text-amber-400 transition-colors">Microsoft 365 Annual Refund</a></li>
                <li><a href="/refund/amazon-prime-refund-after-unwanted-renewal" className="hover:text-amber-400 transition-colors">Amazon Prime Renewal Refund</a></li>
                <li><a href="/refund/chatgpt-plus-refund-request-after-renewal" className="hover:text-amber-400 transition-colors">ChatGPT Plus Renewal Refund</a></li>
                <li><a href="/refund/linkedin-premium-refund-after-free-trial" className="hover:text-amber-400 transition-colors">LinkedIn Premium Trial Refund</a></li>
                <li><a href="/refund/duolingo-super-refund-after-annual-charge" className="hover:text-amber-400 transition-colors">Duolingo Super Refund</a></li>
                <li><a href="/refund/dropbox-annual-renewal-refund-request" className="hover:text-amber-400 transition-colors">Dropbox Annual Refund</a></li>
              </ul>
              <div className="mt-5 pt-4 border-t border-slate-800/40">
            ...
            <div className="glass-card rounded-2xl p-6 border-slate-800/40">
              <h3 className="text-sm font-bold text-slate-100 mb-4 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-violet-500" /> Worked Refund Examples
              </h3>
              <ul className="space-y-3 text-xs text-slate-400">
                <li><a href="/cases/how-i-got-119-back-from-forgotten-canva-pro-trial" className="hover:text-violet-400 transition-colors">Canva Trial Renewal Request Example</a></li>
                <li><a href="/cases/how-to-negotiate-adobe-early-termination-fee-refund" className="hover:text-violet-400 transition-colors">Adobe Fee Review Request Example</a></li>
                <li><a href="/cases/getting-refunded-for-99-dollar-microsoft-365-accidental-renewal" className="hover:text-violet-400 transition-colors">Microsoft 365 Renewal Example</a></li>
              </ul>
              <div className="mt-5 pt-4 border-t border-slate-800/40">
            ...
            <div className="glass-card rounded-2xl p-6 border-slate-800/40">
              ...
              <ul className="space-y-3 text-xs text-slate-400">
                <li><a href="/tools/free-trial-refund-helper" className="hover:text-emerald-400 transition-colors">Free Trial Refund Helper</a></li>
                <li><a href="/tools/cancel-subscription-script-generator" className="hover:text-emerald-400 transition-colors">Cancel Script Generator</a></li>
                <li><a href="/tools/subscription-cost-calculator" className="hover:text-emerald-400 transition-colors">Subscription Cost Calculator</a></li>
                <li><a href="/tools/rocket-money-alternative-no-bank-login" className="hover:text-emerald-400 transition-colors">Rocket Money Alternative</a></li>
                <li><a href="/tools/cancel-subscription-guide" className="hover:text-emerald-400 transition-colors">Cancel Subscription Guide</a></li>
              </ul>
              <div className="mt-5 pt-4 border-t border-slate-800/40">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="relative bg-gradient-to-br from-violet-950/30 to-rose-950/30 rounded-2xl p-7 border border-violet-700/30 flex flex-col shadow-xl shadow-violet-950/10 hover:scale-[1.01] transition-transform">
              ...
              <p className="text-[11px] text-slate-500 mb-6">Prepare a structured dispute packet with relevant card-network references. Approval is always decided by the issuer.</p>
              <ul className="text-xs text-slate-300 space-y-3 mb-8 flex-1">
                {[
